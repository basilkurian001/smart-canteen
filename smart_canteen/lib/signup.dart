        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: <TextSpan>[
                      TextSpan(
                        ...
                        recognizer: TapGestureRecognizer()
                          ..onTap = () {
                            // Navigate to Sign In Screen (named route)
              ...
              const SizedBox(height: 16),
              Center(child: Text("Or", style: TextStyle(color: const Color(0xFF010F07).withOpacity(0.7)))),
              const SizedBox(height: 16),
...
class _SignUpFormState extends State<SignUpForm> {
  ...
  Future<void> _submit() async {
    ...
    try {
      // Call signup; AuthService.signup will save token internally if returned
      final signupResponse = await _auth.signup(name, email, password);
